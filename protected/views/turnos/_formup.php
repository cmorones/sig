...
<?php $form=$this->beginWidget('CActiveForm', array(
 ...
 <fieldset>
  ...
  <div class="form-group">
     <label for="ticket-name" class="col-sm-3 control-label"><?php echo $form->labelEx($model,'folio'); ?></label>
     <div class="col-sm-9">

        <?php echo $form->textField($model,'folio',array('placeholder'=>'instruccion_adicional', 'class'=>"form-control")); ?>               
