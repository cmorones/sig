...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
        ...
        foreach ($resultEjercicio as $key => $value) {
            $ejercicio[$value->id] = $value->id. "-" . $value->nombre;
        }
        ...
        <?php echo $form->error($model,'id_area'); ?>
           ...
           <div class="form-group">
                                                            <label for="ticket-subject" class="col-sm-3 control-label">   <?php echo $form->labelEx($model,'id_dp'); ?></label>
                                                            <div class="col-sm-9">
        ...
        WHERE "public".datos_personales.status = 1 ';
        ...
        $destinatarios['falso'] = 'Seleccionar';
         ...
         foreach ($resultrem as $value) {
                    $destinatarios[$value['id']] = "$value[id] - $value[nombre] $value[apellido_p] $value[apellido_m]";
                }
