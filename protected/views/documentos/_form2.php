...
Yii::app()->clientScript->registerScript('btn', "
    ...
    $('#documentos-form').on('submit', function(e){
      ...
      return false;
            ...
            document.forms['documentos-form'].submit();
...
<div id='info' >
 ...
 <div class="widget">
                                            <div class="widget-header">
                                                <h3><i class="fa fa-edit"></i> Generar Correspondencia <?php echo $model->id; ?></h3>
                                            </div>
...
$listAreas = Areas::model()->listaSimple($valores);
                                                        ...
                                                        <legend>Detalle</legend>
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                ...
                                                                <span class="docto"> <?php echo $model->documento; ?> </span>
                                                            </div>
                                                        </div>
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                ...
                                                                <?php echo $form->textField($model,'referencia',array('id'=>'iddocto','placeholder'=>'Refrerencia', 'class'=>"form-control")); ?>
        ...
        $ejercicio = array();
        $ejercicio['false'] = 'Selecciona tipo de oficio';
 ...
 ?>
        <?php echo $form->error($model,'fecha'); ?>
                         ...
                         <fieldset>
                                                        ...
                                                        <?php 
                                                        if($model->tipo_docto==4){
                                                            echo "Informacion de Circulares";
                                                        }else {
                                                            echo "Informacion de copias";
                                                        }
                                                        ?>
                                                        </legend>
                   <div class="form-group">
                                                            <label for="ticket-name" class="col-sm-3 control-label">
                                                            <?php 

                                                             if($model->tipo_docto==4){
                                                            echo "Destinatarios";
                                                        }else {
                                                             echo $form->labelEx($model, 'copiasIds');
                                                        }
    ...
    'htmlOptions'=>array(
        ...
        'initSelection' => "js:function (element, callback) {
            var id=$(element).val();
            if (id!=='') {
                $.ajax('".$this->createUrl('/api/initCopias')."', {
                    dataType: 'json',
                    data: {
                        id: id
                    }
        ...
        'data-placeholder'=>'Buscar destinatario de copias ...'
    ),
    'events'=>array(
...
<div class="row">
  <div class="form-group">
       ...
       $acusef = base64_decode($acuse);
       if($acusef!=1 && $model->tipo_docto!=4){
       echo CHtml::submitButton($model->isNewRecord ? 'Generar' : 'Guardar',array('id'=>"btn",'class'=>"agregar btn btn-success pull-left"));
...
<button class="ladda-button btn btn-danger" data-style="contract"><span class="ladda-label">
    

    <?php
   echo CHtml::link(
    'Eliminar',
     array('documentos/eliminaDocto','id'=>$model->id, array('class' => 'blanco')),
     array('confirm' => 'Estas seguro?')
);

?>
</span><span class="ladda-spinner"></span><div class="ladda-progress" style="width: 100px;"></div></button>

    </div>

       <?php
       } elseif($model->tipo_docto==4){
...
<?php
echo "<br><span class='docto'>Nota: Al eliminar una circular se eliminarán todos los destinatarios</span>";


}else{
        echo "<span class='docto'>Nota: Este documento ya fue confirmado por el menos un destinatario no se puede modificar, ni eliminar</span>";
       }
