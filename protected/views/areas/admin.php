                    ...
                    <div class="col-md-10 content-wrapper">
                        ...
                        <div class="content">
                            ...
                            <div class="main-content">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                            ...
                                            <div class="widget-header">
                                                <h3><i class="fa fa-desktop"></i> AREAS</h3>
                               ...
                               <p><a href="<?php echo CController::createUrl('areas/create'); ?>" class="btn-sm btn btn-warning pull-left"><i class="glyphicon glypicon-plus"></i>Nueva Area</a></p>
		...
		*/
		 array(
            ...
            'buttons'=>array(
                ...
                'url'=>'yii::app()->createUrl("areas/update",array("id"=>$data->id))',
                ),
            ),
