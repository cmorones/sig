...
class Turnos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('fecha_plazo, fecha_solucuion, solucion', 'required'),
			...
			array('docto_search, fecha_plazo, fecha_reg, fecha_mod', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, folio, docto_search, id_corresp, remitente, estado_rem, destinatario, estado_dest, instruccion1, instruccion2, instruccion_adicional, caracter, fecha_plazo, doc_respuesta, fecha_solucuion, estado, estado_sol, fecha_reg, fecha_mod, user_reg, user_mod', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'fecha_solucuion' => 'Fecha Solucion',
			'estado' => 'Estado',
			'fecha_reg' => 'Fecha Reg',
			'fecha_mod' => 'Fecha Mod',
			'user_reg' => 'User Reg',
	...
	//	$criteria->compare('areas.id',$id_area);
		...
		$criteria->compare('fecha_turno',$this->fecha_turno);
