...
class XTreeBehavior extends CActiveRecordBehavior
{
	 ...
	 */
	public function getMenuItems($id=null,$showRoot=true,$perfil)
	{
		...
		if ($showRoot===false)
		{
			$models=$owner->findAll(array(
				'condition'=>'parent_id='.$rootId.' and id_perfil='.$perfil.'',
				//$this->parent_id.'='.$rootId,
				//'condition'=>$this->id_perfil.'='.$perfil,
				'order'=>$this->sort
			));
			if($models===null)
