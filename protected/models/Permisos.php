...
class Permisos extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			  'parent' => array(self::BELONGS_TO, 'Permisos', 'parent_id'),
			  'children' => array(self::HAS_MANY, 'Permisos', 'parent_id', 'order' => 'position'),
			  'childCount' => array(self::STAT, 'Permisos', 'parent_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('label',$this->link,true);
		$criteria->compare('position',$this->position);
		$criteria->compare('link',$this->link,true);
		$criteria->compare('bloq',$this->bloq);
