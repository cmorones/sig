...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'doc_respuesta',array('size'=>60,'maxlength'=>200)); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'fecha_solucion'); ?>
		<?php echo $form->textField($model,'fecha_solucion'); ?>
